...
{
	if(isset($campaign))
		$subject="COLUMBIA GBP Program Query - [".$campaign."] [".$lead_source."] [".$country."] - M";
	else
		$subject="COLUMBIA GBP Program Query - [".$lead_source."] [".$country."] - M";
}
else
{
	if(isset($campaign))
		$subject="COLUMBIA GBP Program Query - [".$campaign."] [".$lead_source."] [".$country."]";
	else
		$subject="COLUMBIA GBP Program Query - [".$lead_source."] [".$country."]";
}
/*
Do Not Store Data
	...
	*/
	...
	{
		header('Location: http://www.eruditus.com/programmes/columbia-gbp/'.$thankyoupage.'?vd_lid='.$lead_id.'&email='.$email.'&valid=0');
		exit;
	}
	else{
...
<html>
<head>
<title>Global Banking Program: Fintech | Digital | Analytics (GBP FDA)</title>
...
<form class="form-horizontal mCustomScrollbar" role="form" id="frm" name="frm" action="https://www2.eruditus.com/l/63132/2017-12-18/2j7y13y" method="POST">
<input type="hidden" name="oid" value="00D90000000K0sz">
<input type="hidden" name="retURL" value="https://www.eruditus.com/programmes/columbia-gbp/<?php echo $thankyoupage;?>">
<input type="hidden" name="00N90000002EM3X" value="Columbia GBP" />
