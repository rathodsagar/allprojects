...
// empty($attenddate) || empty($finance) || 
if(empty($city))
{
	$city= "XYZ";
}
	...
	<tr>
    	<td>
        	<table width='100%' cellpadding='10' cellspacing='0' border='0'>
            	<tr>
                	<td bgcolor='#f0f0f0'><img src='http://eruditus.com/programmes/mit-sloan-epgm/images/logo.png' width='91' height='100' alt='MIT-SLOAN' />
                    </td>
              </tr>
                <tr>
                  <td height='10'></td>
                ...
                <tr>
                  <td><font face='Arial, Helvetica, sans-serif' size='2' color='#666666'>Thanks for your interest in the <strong> Executive Program in General Management (EPGM)</strong>.</font></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><font face='Arial, Helvetica, sans-serif' size='2' color='#666666'>Best Regards,<br />
                    The MIT EPGM Team</font></td>
                </tr>
                <tr>
               	  <td align='right' style='border-top:solid 1px #cccccc;'><img src='http://www.eruditus.com/images/programmes/columbia/eruditus_program_partner.jpg' alt='Program Partner: Eruditus Executive Education' width='269' height='47' border='0' />
                    </td>
              </tr>
          </table>
        </td>
...
<form class="form-horizontal mCustomScrollbar" role="form" id="frm" name="frm" action="http://www2.eruditus.com/l/63132/2017-10-16/2d2hq9j" method="POST">
<input type="hidden" name="oid" value="00D90000000K0sz">
<input type="hidden" name="retURL" value="http://www.eruditus.com/programmes/berkeley-data-science-analytics/<?php echo $thankyoupage;?>">
<input type="hidden" name="00N90000002EM3X" value="Berkeley PDSA" />
