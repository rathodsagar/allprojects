...
function populateCountries(countryElementId, codeElementId){
	...
	if( codeElementId ){
		countryElement.onchange = function(){
			populateCountryCode( countryElementId, codeElementId );
		};
	}
}