...
<body>
        ...
        <div class="container-fluid">
            <div class="row align-items-center mb-md-3 mb-0">
                <div class="col-md-6 col-12">
                    <h1 class="comm-heading mb-md-0">List Users</h1>
                </div>
                <div class="col-md-6 col-12 sticky-bottom">
                    <div class="action-btn">
                        <button class="btn btn-outline-icon filter filter-leads" data-bs-toggle="modal" data-bs-target="#filterUsers">Filter</button>
                        <a href="#" class="btn btn-fill-icon add">Add Users</a>
                        <a href="#" class="btn btn-fill-icon done">Active</a>
                        <a href="#" class="btn btn-fill-icon close">Deactive</a>
                    ...
                    <table class="table table-striped comm-table-striped">
                        ...
                        <tbody id="leadListBody" >
                            <tr>
                                ...
                                <td class="name" data-title="Name:">Test Ameyo</td>
                                <td class="email" data-title="Email:">abc@gmail.com</td>
                                <td class="username" data-title="Username:">test</td>
                                <td class="role" data-title="Role:">Agent</td>
                                <td class="lead-allocate" data-title="Lead Allocated:">Agent</td>
                                <td class="status w50 title-top" data-title="Status:">
                                    <button type="button" class="btn btn-approve">Active</button>
                                </td>
                                <td class="login-status w50 title-top" data-title="Login Status:">
                                    <button type="button" class="btn btn-approve">Active</button>
                                </td>
    ...
    <section class="modal fade comm-modal right" id="filterUsers" >
                ...
                <div class="modal-body">
                    <form class="" id="" medthod="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="userName" id="userName" placeholder="Search By User Name">
                        </div>
                        <div class="form-group select">
                            <label for="usersRole" class="form-label">Select Role</label>
                            <select name="usersRole" id="usersRole" class="form-select">
                        ...
                        <div class="form-group select">
                            <label for="usersLocation" class="form-label">Select Location</label>
                            <select name="usersLocation" id="usersLocation" class="form-control">
                                <option value="">Select Location</option>
                                <option value="">1Point1</option>
                                <option value="">Digital Team</option>
                                <option value="">financial-agency</option>
                                <option value="">My Insurance Club</option>
                                <option value="">Platinumone</option>
                                <option value="">PolicyBazzar</option>
                                <option value="">Vovitek Kreate</option>
                            </select>
                        </div>
                        <div class="form-group select">
                            <label for="userStatus" class="form-label">Select Location</label>
                            <select name="userStatus" id="userStatus" class="form-control">
								<option value="" selected="selected">All</option>
                                <option value="">Actived</option>
                                <option value="">Deactived</option>
							</select>
                        </div>
